...
(function($) {
	$.widget( "mobile.datebox", $.mobile.widget, {
		...
		_create: function() {
			...
			if ( o.useButton === true && o.useInline === false && o.useNewStyle === false ) {
				...
				w.d.open = $('<a href="#" class="ui-input-clear" title="'+this.__('tooltip')+'">'+this.__('tooltip')+'</a>')
					.live(o.clickEvent, function(e) {
						e.preventDefault();
						if ( !w.disabled ) { w.d.input.trigger('datebox', console.log('open logged...'), {'method': 'open'}); w.d.wrap.addClass('ui-focus'); }
			...
			w.d.screen = $("<div>", {'class':'ui-datebox-screen ui-datebox-hidden'+((o.useModal)?' ui-datebox-screen-modal':'')})
				...
				.live(o.clickEventAlt, function(e) {
					e.preventDefault();
			...
			w.d.wrap.live(o.clickEvent, function() {
			...
			if ( o.useInline === true || o.useInlineBlind ) {
						console.log('open logged...'), w.open(); }
		...
		open: function () {
			...
			if ( o.dialogForce || ( o.dialogEnable && window.width() < 400 ) ) {
				...
				w.d.dialogPage.find('.ui-header').find('a').off('click vclick').live(o.clickEventAlt, function(e) { e.preventDefault(); w.d.input.trigger('datebox', {'method':'close'}); });
				...
				if ( o.useHeader === true ) {
					...
					$("<a class='ui-btn-left' href='#'>Close</a>").appendTo(w.d.headHTML)
						...
						.live(o.clickEventAlt, function(e) { e.preventDefault(); w.d.input.trigger('datebox', {'method':'close'}); });
				...
				$(document).live('orientationchange.datebox', {widget:w}, function(e) { w._applyCoords(e.data); });
				if ( o.resizeListener === true ) {
					$(window).live('resize.datebox', {widget:w}, function (e) { w._applyCoords(e.data); });
				}
			}
		},
		close: function() {
			...
			if ( w.d.dialogPage !== false ) {
				...
				if ( ! $.mobile.activePage.jqmData('page').options.domCache ) {
					$.mobile.activePage.live('pagehide.remove', function () { $(this).remove(); });
				}
	...
	$( document ).live( "pagecreate create", function( e ){
